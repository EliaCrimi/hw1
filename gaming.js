...
function onJson(json) {
    ...
    aggiungi.classList.add('add');
    contieniImg.appendChild(aggiungi);
    aggiungi.setAttribute("nome", json.data.displayName);
    aggiungi.setAttribute("img", json.data.fullPortrait);
...
function fadd(event) {
    ...
    console.log(nome);
    console.log(img);
    fetch("http://localhost/agenttable.php?agent=" + nome + "&urlimg=" + img).then(response => {
